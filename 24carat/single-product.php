    ...
    <main>
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                ...
                <div class="small-image-group">
                    <div class="small-image-col">
                        <img src="assets/products/f1.jpg" width="100%" id="smallImg" alt="">
                    </div>
                    <div class="small-image-col">
                        <img src="assets/products/f2.jpg" width="100%" id="smallImg" alt="">
                    </div>
                    <div class="small-image-col">
                        <img src="assets/products/f3.jpg" width="100%" id="smallImg" alt="">
                    </div>
                    <div class="small-image-col">
                        <img src="assets/products/f4.jpg" width="100%" id="smallImg" alt="">
                    </div>
                </div>
            </div>
            <div class="single-pro-details">
                ...
                <a href="" class="btn-new">Add To Cart</a>
                <h4>Product Details</h4>
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ab neque tempore ut. Non delectus possimus
                    voluptates, tempore aspernatur numquam porro voluptatibus in suscipit facere dolorem consequuntur
                    maxime mollitia atque facilis ipsa, amet assumenda id ducimus corporis, ab cumque? Magni, hic? Lorem
                    ipsum dolor sit amet consectetur adipisicing elit Officiis excepturi soluta neque esse provident
                    explicabo minus veritatis at iusto ut Lorem ipsum dolor sit amet consectetur adipisicing elit
                    Doloribus id</p>
            </div>
        </section>
